...
data_dir <- c(I2 = "/home/Jayne.Wiarda/SI_PP_SC_ST/OutputFinalQC_SConly/I2Scrubbed",
              I3 = "/home/Jayne.Wiarda/SI_PP_SC_ST/OutputFinalQC_SConly/I3Scrubbed",
              I4 = "/home/Jayne.Wiarda/SI_PP_SC_ST/OutputFinalQC_SConly/I4Scrubbed",
              J2 = "/home/Jayne.Wiarda/SI_PP_SC_ST/OutputFinalQC_SConly/J2Scrubbed",
              J3 = "/home/Jayne.Wiarda/SI_PP_SC_ST/OutputFinalQC_SConly/J3Scrubbed",
              J4 = "/home/Jayne.Wiarda/SI_PP_SC_ST/OutputFinalQC_SConly/J4Scrubbed")
lapply(data_dir, dir) # Should show barcodes.tsv.gz, genes.tsv.gz, and matrix.mtx.gz for each sample listed

##Create a Seurat object with all six samples included.
...
seu = CreateSeuratObject(counts = scRNA_data,
                         min.cells = 1) # create Seurat object
...
#          ndims = 50) # look at this plot to find the 'elbow' for significant PCs... use this number of PCs for creating UMAP, tSNE, & cell neighbors & clustering
...
SaveH5Seurat(seu.integrated, 
             filename = "/home/Jayne.Wiarda/SI_PP_SC_ST/NormalizeIntegrateDimReduc_SConly/AllSamples.h5Seurat", overwrite = TRUE)
rm(seu.integrated)
...
#### Save the Seurat object
SaveH5Seurat(seu.integrated, 
             filename = "/home/Jayne.Wiarda/SI_PP_SC_ST/NormalizeIntegrateDimReduc_SConly/JejunumOnly.h5Seurat", overwrite = TRUE)
rm(seu.integrated)
...
#### Save the Seurat object
SaveH5Seurat(seu.integrated, 
             filename = "/home/Jayne.Wiarda/SI_PP_SC_ST/NormalizeIntegrateDimReduc_SConly/IleumOnly.h5Seurat", overwrite = TRUE)
rm(seu.integrated)
